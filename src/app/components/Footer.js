...
const Footer = () => {
  ...
  const mainLinks = [
    ...
    { label: 'bookings', href: 'https://calendly.com/d/49d-j7x-xn4/presentacion-de-servicios' }
  ];
  ...
  const productLinks = [
    { label: 'Live Chat', href: 'https://wa.me/+525633330404' },
    { label: 'Reviews', href: '/#value_ur_time' },
  ];
  ...
  return (
    <>
          ...
          <div className="pt-8 md:pt-10 lg:pt-12 xl:pt-16">
            <div className="grid gap-5 grid-cols-24">
                ...
                <div className="mb-10">
                  ...
                  <ul className="space-y-2">
                    {contactLinks.map((link, index) => (
                      <li key={index}>
                        <Link href={link.href} className="font-main text-main-200 hover:text-main-100 text-base font-normal leading-0 transition-colors flex items-center gap-3">
                ...
                <div className="mb-10">
                  ...
                  <ul className="space-y-2">
                    {mainLinks.map((link, index) => (
                      <li key={index}>
                        <Link href={link.href} className="font-main text-main-200 hover:text-main-100 text-base font-normal capitalize leading-0 transition-colors tracking-foot-text">
                          {link.label}
                        </Link>
                      </li>
                    ))}
              ...
              <div className="col-span-22 sm:col-span-12 md:col-span-14 lg:col-span-10 xl:col-span-7">
                <form className="w-[90%] mb-10 pr-12 md:pr-0" action="https://wa.me/+525633330404">
                    ...
                    <div className="px-2 py-3 justify-center items-center flex absolute top-1 left-1">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          ...
                          stroke="#9A9EA6" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M11.3337 6L9.24699 7.66667C8.56032 8.21333 7.43366 8.21333 6.74699 7.66667L4.66699 6"
                          stroke="#9A9EA6" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                    </div>
                    <button
                      className="absolute top-1 right-1 px-9 py-3 bg-main-600 hover:bg-main-500 rounded-3xl text-center text-white text-xs font-bold transition-colors">
                      Submit
                    </button>
                  </div></form>
              </div>
      ...
      <Link className="fixed right-6 lg:right-9 bottom-6 lg:bottom-9 bg-main-700 p-3 rounded-full shadow-lg" href="https://wa.me/+525633330404">
