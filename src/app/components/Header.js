        ...
        <nav className="">
          <div className="flex flex-wrap items-center justify-between p-4 mx-auto">
            ...
            <div className={`${isMenuOpen ? 'block md:block bg-white' : 'hidden md:block'}  w-full md:w-auto`} id="navbar-default">
              <ul className={`flex justify-end items-center flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 ${isMenuOpen ? ' space-y-4 ' : ''} md:mt-0`}>
                {menu.map((item, index) => {
                  return <li key={index}>
                ...
                <li>
                  <a href="#" className="block px-8 py-3 font-medium leading-none border border-gray-600 md:py-4 font-main text-primary hover:bg-main-200 rounded-3xl">
                    Login
                  </a>
                </li>
                <li>
                          ...
                          <Menu.Item>
                            {({ active }) => (
                              ...
                              >
                                {active ? (
                                  <Image
                                    className="w-6 h-4 transition-all group-hover:scale-110"
