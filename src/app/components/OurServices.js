...
const OurServices = () => {
  ...
  const services = [
    {
      title: t("home.ourServices_section_1"),
      icon: "icon-file",
    },
    {
      title: t("home.ourServices_section_2"),
      icon: "icon-map",
    },
    {
      title: t("home.ourServices_section_3"),
      icon: "icon-money",
    },
    {
      title: t("home.ourServices_section_4"),
      icon: "icon-chart",
    },
    {
      title: t("home.ourServices_section_5"),
      icon: "icon-chartup",
    },
    {
      title: t("home.ourServices_section_6"),
      icon: "icon-user",
    },
  ];
  return (
    ...
    >
        ...
        <div className="container-main relative z-10">
          <div className="section-header flex flex-col items-center justify-center text-center mb-12 md:mb-16 lg:mb-16">
            <p className="sec-sub-title text-primary mb-6">
              {t("home.ourServices_subTitle")}
            </p>
            <h2 className="sec-title text-body max-w-fit relative mb-6">
              {t("home.ourServices_title")}
              <span className="inline-block text-gray-200 py-1 px-2 bg-gray-900 font-black font-main">
              {t("home.ourServices_highlight")}
              
              

              </span>
              <svg
                className="absolute right-2 lg:right-3 -bottom-3 md:-bottom-5 w-[65%]"
                width="240"
                height="12"
                viewBox="0 0 249 13"
                fill="none"
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              {t("home.ourServices_scheduleMeeting")}
            </a>
          </div>
        </div>
      </Fade>
      ...
      <svg
        className="z-0 absolute right-0 bottom-24 lg:top-32 w-[35%]"
        width="550"
        height="1000"
        viewBox="0 0 631 1209"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
          ...
          height="977.546"
          rx="102.683"
          transform="matrix(-0.707107 0.707107 0.707107 0.707107 220.216 78)"
          fill="#E8ECEE"
          fillOpacity="0.3"
        />
        <rect
          ...
          height="977.546"
          rx="102.683"
          transform="matrix(-0.707107 0.707107 0.707107 0.707107 493.216 0)"
          fill="#E8ECEE"
          fillOpacity="0.3"
        />
        <rect
          ...
          height="977.546"
          rx="102.683"
          transform="matrix(-0.707107 0.707107 0.707107 0.707107 145.216 372)"
          fill="#E8ECEE"
          fillOpacity="0.3"
        />
      </svg>
      ...
      <svg
        className="z-0 absolute left-0 bottom-0 w-[35%]"
        width="550"
        height="1000"
        viewBox="0 0 650 1209"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
          ...
          height="977.546"
          rx="102.683"
          transform="rotate(45 440.229 78)"
          fill="#E8ECEE"
          fillOpacity="0.3"
        />
        <rect
        ...
        <rect
          ...
          height="977.546"
          rx="102.683"
          transform="rotate(45 504.229 372)"
          fill="#E8ECEE"
          fillOpacity="0.3"
        />
      </svg>
