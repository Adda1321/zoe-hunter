...
const WelcomeSection = () => {
  ...
  return (
    <section id="home" className="relative bg-section-100 pb-16 md:pb-20 lg:pb-24 pt-28 md:pt-28 lg:pt-32 z-0">
            ...
            <Slide bottom>
              ...
              <div className="flex flex-wrap gap-3 mt-6 md:mt-8 lg:mt-10">
                ...
                >
                  ...
                  {t("home.welcome_btn_1")}
                </Link>
                <Link className="btn-white" href="#our_services">
                  {t("home.welcome_btn_2")}
                </Link>
              </div>
            </Slide>
          </div>
